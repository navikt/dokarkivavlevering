...
public class SqlQueries {
	static final String FINN_SAKER_SQL =
			"select sa.id                         as id,\n" +
					...
					"       alj.utfoert_av                as journalposter_arkivendringer_utfoertav,\n" +
					"       aeej.fra_verdi                as journalposter_arkivendringer_fraverdi,\n" +
					"       aeej.til_verdi                as journalposter_arkivendringer_tilverdi,\n" +
					"       aeed.arkiv_element_endring_id as journalposter_dokumenter_arkivendringer_id,\n" +
					"       aeed.arkiv_element            as journalposter_dokumenter_arkivendringer_element,\n" +
					"       ald.tidspunkt                 as journalposter_dokumenter_arkivendringer_tidspunkt,\n" +
					"       ald.utfoert_av                as journalposter_dokumenter_arkivendringer_utfoertav,\n" +
					"       aeed.fra_verdi                as journalposter_dokumenter_arkivendringer_fraverdi,\n" +
					"       aeed.til_verdi                as journalposter_dokumenter_arkivendringer_tilverdi\n" +
					"from sak sa\n" +
					...
					"order by sa.id, j.journalpost_id, r.k_tilkn_jp_som, r.dokument_info_id, f.fil_detaljer_id, aeej.arkiv_element_endring_id,\n" +
